...
class TestusersReset extends Migration {
	...
	public function up()
	{
	    ...
	    // remove user
		$user = $sentry->findUserByLogin('dev1@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('dev2@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('dev3@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('dev4@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('tester@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('po@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('agile@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('cus1@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('cus2@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('cus3@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('user1@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('user2@apha.com'); $user->forceDelete();
        $user = $sentry->findUserByLogin('user3@apha.com'); $user->forceDelete();
